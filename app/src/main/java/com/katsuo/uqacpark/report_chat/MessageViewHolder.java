...
public class MessageViewHolder extends RecyclerView.ViewHolder {
    ...
    //ROOT VIEW
    @BindView(R.id.report_chat_item_root_view) RelativeLayout rootView;

    //PROFILE CONTAINER
    @BindView(R.id.report_chat_item_profile_container) LinearLayout profileContainer;
    @BindView(R.id.report_chat_item_profile_container_profile_image) ImageView imageViewProfile;
    @BindView(R.id.report_chat_item_profile_container_is_admin_image) ImageView imageViewIsAdmin;

    //MESSAGE CONTAINER
    @BindView(R.id.report_chat_item_message_container) RelativeLayout messageContainer;
    //IMAGE SENDED CONTAINER
    @BindView(R.id.report_chat_item_message_container_image_sent_cardview)
    CardView cardViewImageSent;
    @BindView(R.id.report_chat_item_message_container_image_sent_cardview_image)
    ImageView imageViewSent;
    //TEXT MESSAGE CONTAINER
    @BindView(R.id.report_chat_item_message_container_text_message_container)
    LinearLayout textMessageContainer;
    @BindView(R.id.report_chat_item_message_container_text_message_container_text_view) TextView textViewMessage;
    //DATE TEXT
    @BindView(R.id.report_chat_item_message_container_text_view_date)
    ...
    public void updateWithMessage(Message message, String currentUserId, RequestManager glide){
        ...
        // Update isAdmin ImageView
        this.imageViewIsAdmin.setVisibility(message.getUserSender().getIsAdmin() ? View.VISIBLE : View.INVISIBLE);
    ...
    private void updateDesignDependingUser(Boolean isSender){
        ...
        paramsLayoutContent.addRule(isSender ? RelativeLayout.LEFT_OF : RelativeLayout.RIGHT_OF, R.id.report_chat_item_profile_container);
        ...
        paramsImageView.addRule(isSender ? RelativeLayout.ALIGN_LEFT : RelativeLayout.ALIGN_RIGHT, R.id.report_chat_item_message_container_text_message_container);
